...
- **Just-Dance-style rigged dancer.** Replace the generated geometric silhouette
  (`drawHumanFigure`) with a rigged 2D character sprite that deforms with the tracked pose.
  Needs an art asset + skeletal rig.
